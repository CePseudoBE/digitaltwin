...
const require = createRequire(import.meta.url + '/../../packages/engine/package.json')
const built = require.resolve('ioredis').replace(/built[\/].*$/, 'built')
...
console.log('instrumented', built, (redis.match(/createdStack/g) || []).length)
